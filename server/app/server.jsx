...
export default function render (req, res) {
  console.log('req.user client', req.user)
  console.log('req.user client', req.path)
  ...
  if (req.rolesInfo) {
    let userInfo = {
      rolesInfo: req.rolesInfo
            // roles: req.user.__data.roles,
            // isAdmin,
    }
    Object.assign(user, { userInfo })
  }
  console.log('client UERER u USER ', user)
